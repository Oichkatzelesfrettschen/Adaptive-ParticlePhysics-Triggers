...
def process_h5_file0(input_filename):
    ...
    with h5py.File(input_filename, 'r') as h5_file:
        ...
        print(f'n_events: {n_events} for file name {input_filename}.') 
        n_jets = 8  
        n_features = 4  
...
print('Size of X_train {} and X_test {}'.format(len(X_train), len(X_test)))
...
plt.legend()
plt.tight_layout()
# plt.savefig("RealData/paper_data/random.pdf")
out_path = Path("RealData/paper_data/random.pdf")
